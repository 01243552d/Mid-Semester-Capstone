...
void ViewLectureSession() {
    cout << "==================== Lecture Session(s) ====================\n\n";
    cout << "Course Code | Course Name              | Day     | Start Time | End Time | Duration\n";
    cout << "-------------------------------------------------------------------------------------\n";
    cout << "EEE227      | Introduction to C++      | Tuesday | 1 PM       | 4 PM     | 3 HRS\n";
}
...
int main() {
    ...
    do {
        ...
        cout << "7. Export Attndance to Excel\n";
        cout << "0. Exit\n";
        cout << "Choice:-> ";
